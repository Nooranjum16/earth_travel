  ...
  crew: [
    {
      ...
      role: "Commander",
      name: "John",
      bio: "John is an American engineer, former Marine Corps pilot and former NASA astronaut. He launched into space for the third time as commander of Crew Dragon Demo-2.",
    },
    {
      img: markIMG,
      role: "Mission Specialist",
      name: "Harry",
      bio: "Harry is the founder and CEO of Canonical, the company behind the Linux-based Ubuntu operating system. Shuttleworth became the first South African to travel to space as a space tourist.",
    },
    {
      img: victorIMG,
      role: "Pilot",
    ...
    },
    {
      ...
      name: "Fatima Ansari",
      bio: "Fatima Ansari is an Iranian American engineer and co-founder of Prodea Systems. Ansari was the fourth self-funded space tourist, the first self-funded",
    },
  ],
};
