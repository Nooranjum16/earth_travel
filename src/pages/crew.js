        ...
        <div className={styles.crewMain}>
              ...
              {data.crew.map((crewMember) => {
                return (
                  <button
                    ...
                    className={`${
                      linkActive === crewMember.name.replace(/\s+/g, "")
                        ? styles.linkActive
                        : ""
                    } ${styles.crewBtn}`}
                    onClick={handleNav}
            ...
            <div className={styles.cardsContainer}>
              {data.crew.map((crewMember, i) => {
                return (
                  <article
                    key={crewMember.name}
                    className={`${crewMember.name.replace(/\s+/g, "")}-card ${
          ...
          <div className={styles.crewImages}>
            {data.crew.map((crewMember, i) => {
              return (
                <div
                  className={`${styles.crewImg} ${crewMember.name.replace(
                    /\s+/g,
                    ""
