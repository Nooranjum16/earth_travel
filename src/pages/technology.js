...
export default function Technology() {
  const [linkActive, setLinkActive] = useState(
    data.technologies[0].name.replace(/\s+/g, "")
  );
  ...
  return (
    <>
      <Head>
        <title>Earth travel | Technology</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta property="og:title" content="earth travel | Technology" />
        ...
        <div className={styles.main}>
              ...
              return (
                <button
                  ...
                  className={`${styles.techBtn} ${
                    technology.name.replace(/\s+/g, "") === linkActive
                      ? styles.btnActive
                      : ""
                  }`}
          ...
          <div className={styles.infoContainer}>
            {data.technologies.map((technology, i) => (
              <article
                key={technology.name}
                className={`${technology.name.replace(/\s+/g, "")}-card ${
                  i === 0 ? "" : styles.sliderHidden
                }`}
              >
          ...
          <div className={styles.techImages}>
            {data.technologies.map((technology, i) => {
              return (
                <Image
                  className={`${styles.techImg} ${technology.name.replace(
                    /\s+/g,
                    ""
                  )}-img ${i === 0 ? "" : styles.imgHidden}`}
